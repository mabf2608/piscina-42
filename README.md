<div id="header" align="center">
  <img src="https://www.42malaga.com/wp-content/uploads/2021/01/42-Malaga-Fundacion-Telefonica.png" width="1312"/>
</div>

# [School 42 Málaga](https://www.42malaga.com/) - Piscina de Junio - Julio de 2026
> Ejercicios realizados durante la piscina de Junio - Julio de 2026
...
### Shell
Los primeros días de la piscina se realizan dos tandas de ejercicios de *Shell* para aprender los comandos más básicos hasta algunos avanzados, de esta manera, desarrollamos la habilidad de movernos por la terminal :computer: de una forma rápida y eficiente, crear scripts, conocer los comandos de Shell, las variables de entorno, el sistema de archivos, etc.
...
Se conoce como _C Piscine_ ya que es el principal lenguaje de programación en el que se trabaja. Es necesario dominar estructuras de control, variables, todo tipo de operadores, librerías, punteros, _arrays_, funciones, etc.
